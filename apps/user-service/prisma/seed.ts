...
const permissions: PermissionSeed[] = [
  ...
  { name: 'cinema:create:global', resourceCode: 'cinema', action: PermissionAction.CREATE, scope: PermissionScope.GLOBAL },
  { name: 'cinema:delete:global', resourceCode: 'cinema', action: PermissionAction.DELETE, scope: PermissionScope.GLOBAL },
  { name: 'movie:create:global', resourceCode: 'movie', action: PermissionAction.CREATE, scope: PermissionScope.GLOBAL },
  { name: 'movie:update:global', resourceCode: 'movie', action: PermissionAction.UPDATE, scope: PermissionScope.GLOBAL },
  { name: 'movie:delete:global', resourceCode: 'movie', action: PermissionAction.DELETE, scope: PermissionScope.GLOBAL },
