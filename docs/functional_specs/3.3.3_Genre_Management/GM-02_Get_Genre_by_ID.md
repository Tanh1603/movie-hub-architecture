...
Actor -> GW: (1) GET /v1/genres/:id [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `genre.detail` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Get Genre by ID" function and receives the request/event.<br>❖ The system uses trigger [GET /v1/genres/:id]. |
...
| (5) | BR3 | Retrieval Rules:<br>❖ Genre create/update requires non-empty name; payload is strict and unknown fields are not part of the contract. |
