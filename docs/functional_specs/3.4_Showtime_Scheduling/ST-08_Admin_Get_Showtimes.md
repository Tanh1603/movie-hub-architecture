...
Actor -> GW: (1) GET /v1/cinemas/:cinemaId/movies/:movieId/showtimes/admin [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `cinema.admin_showtime` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Admin Get Showtimes" function and receives the request/event.<br>❖ The system uses trigger [GET /v1/cinemas/:cinemaId/movies/:movieId/showtimes/admin]. |
| (3) | BR2 | Validate Rules:<br>❖ The system checks the items [cinemaId], [movieId], [date], [status], [format], [hallId], [language].<br>❖ The system validates data according to DTO/schema AdminGetShowtimesQuery.<br>❖ Required fields: [cinemaId], [movieId], [date].<br>❖ If any required entries are empty, the system shows error message MSG 1.<br>❖ Optional fields: [status], [format], [hallId], [language].<br>❖ Field constraint: [cinemaId] is required, type string, path parameter.<br>❖ Field constraint: [movieId] is required, type string, path parameter.<br>❖ Field constraint: [date] is required, type string.<br>❖ Field constraint: [status] is optional, type value, allowed values: ShowtimeStatusEnum.<br>❖ Field constraint: [format] is optional, type value, allowed values: FormatEnum.<br>❖ Field constraint: [hallId] is optional, type string.<br>❖ Field constraint: [language] is optional, type string.<br>❖ If any type, format, enum, range, date, UUID, or email constraint is invalid, the system shows error message MSG 4. |
