...
Actor -> GW: (1) POST /v1/showtimes/batch [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `showtime.batch_create_showtimes` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Create Batch Showtimes" function and receives the request/event.<br>❖ The system uses trigger [POST /v1/showtimes/batch]. |
| (3) | BR2 | Validate Rules:<br>❖ The system checks the items [movieId], [movieReleaseId], [cinemaId], [hallId], [startDate], [endDate], [timeSlots], [repeatType], [weekdays], [format], [language], [subtitles], [status].<br>❖ The system validates data according to DTO/schema BatchCreateShowtimesInput.<br>❖ Required fields: [movieId], [movieReleaseId], [cinemaId], [hallId], [startDate], [endDate], [timeSlots], [repeatType], [language].<br>❖ If any required entries are empty, the system shows error message MSG 1.<br>❖ Optional fields: [weekdays], [format], [subtitles], [status].<br>❖ Default values: [weekdays] = [], [format] = FormatEnum.TWO_D, [subtitles] = [], [status] = ShowtimeStatusEnum.SELLING.<br>❖ Field constraint: [movieId] is required, type string, minimum 1.<br>❖ Field constraint: [movieReleaseId] is required, type string, minimum 1.<br>❖ Field constraint: [cinemaId] is required, type string, minimum 1.<br>❖ Field constraint: [hallId] is required, type string, minimum 1.<br>❖ Field constraint: [endDate] is required, type string.<br>❖ Field constraint: [timeSlots] is required, type array<string>.<br>❖ Field constraint: [repeatType] is required, type enum, allowed values: DAILY, WEEKLY, CUSTOM_WEEKDAYS.<br>❖ Field constraint: [weekdays] is optional, type array<number>, default [], minimum 0; maximum 6.<br>❖ Field constraint: [format] is optional, type value, default FormatEnum.TWO_D, allowed values: FormatEnum.<br>❖ Field constraint: [language] is required, type string, minimum 1.<br>❖ Field constraint: [subtitles] is optional, type array<string>, default [].<br>❖ Field constraint: [status] is optional, type value, default ShowtimeStatusEnum.SELLING, allowed values: ShowtimeStatusEnum.<br>❖ If any type, format, enum, range, date, UUID, or email constraint is invalid, the system shows error message MSG 4. |
| (5) | BR3 | Creating Rules:<br>❖ Deleting or cancelling showtimes must respect existing bookings/reservations and service constraints.<br>❖ Seat map/TTL reads combine persisted showtime/seat data with Redis held-seat state for the requesting user.<br>❖ Create actions must reject duplicate/conflicting records before persistence and return the created DTO after persistence. |
