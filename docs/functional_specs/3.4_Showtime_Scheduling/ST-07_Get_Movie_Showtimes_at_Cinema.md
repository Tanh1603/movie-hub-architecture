...
Actor -> GW: (1) GET /v1/cinemas/:cinemaId/movies/:movieId/showtimes [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `cinema.showtime` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Get Movie Showtimes at Cinema" function and receives the request/event.<br>❖ The system uses trigger [GET /v1/cinemas/:cinemaId/movies/:movieId/showtimes]. |
| (3) | BR2 | Validate Rules:<br>❖ The system checks the items [cinemaId], [movieId], [date].<br>❖ The system validates data according to DTO/schema GetShowtimesQuery.<br>❖ Required fields: [cinemaId], [movieId].<br>❖ If any required entries are empty, the system shows error message MSG 1.<br>❖ Optional fields: [date].<br>❖ Field constraint: [cinemaId] is required, type string, path parameter.<br>❖ Field constraint: [movieId] is required, type string, path parameter.<br>❖ If any type, format, enum, range, date, UUID, or email constraint is invalid, the system shows error message MSG 4. |
