...
Actor -> GW: (1) DELETE /v1/concessions/:id [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `concession.delete` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Delete Concession" function and receives the request/event.<br>❖ The system uses trigger [DELETE /v1/concessions/:id]. |
