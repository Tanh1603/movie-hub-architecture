...
Actor -> GW: (1) POST /v1/loyalty/redeem [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `loyalty.redeemPoints` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Redeem Points" function and receives the request/event.<br>❖ The system uses trigger [POST /v1/loyalty/redeem]. |
