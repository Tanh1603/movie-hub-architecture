...
Actor -> GW: (1) GET /v1/cinemas/search [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `CINEMA.SEARCH_CINEMAS` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Search Cinemas by Query" function and receives the request/event.<br>❖ The system uses trigger [GET /v1/cinemas/search]. |
| (3) | BR2 | Validate Rules:<br>❖ The system checks the items [query], [lat], [lon].<br>❖ Required fields: [query].<br>❖ If any required entries are empty, the system shows error message MSG 1.<br>❖ Optional fields: [lat], [lon].<br>❖ Field constraint: [query] is required, type string, query parameter.<br>❖ Field constraint: [lat] is optional, type string, query parameter.<br>❖ Field constraint: [lon] is optional, type string, query parameter.<br>❖ If any type, format, enum, range, date, UUID, or email constraint is invalid, the system shows error message MSG 4. |
...
| (8) | BR5 | Error Handling Rules:<br>❖ Gateway forwards the request to the target service through microservice pattern CINEMA.SEARCH_CINEMAS and propagates service errors through the common exception layer.<br>❖ If a constraint, conflict, or unexpected failure occurs, the system shows error message MSG 9. |
