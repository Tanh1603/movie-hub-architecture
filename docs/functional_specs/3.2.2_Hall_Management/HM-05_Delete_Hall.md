...
Actor -> GW: (1) DELETE /v1/halls/hall/:hallId [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `hall.delete` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Delete Hall" function and receives the request/event.<br>❖ The system uses trigger [DELETE /v1/halls/hall/:hallId]. |
| (3) | BR2 | Validate Rules:<br>❖ The system checks the items [hallId].<br>❖ Required fields: [hallId].<br>❖ If any required entries are empty, the system shows error message MSG 1.<br>❖ Field constraint: [hallId] is required, type string, path parameter.<br>❖ If any type, format, enum, range, date, UUID, or email constraint is invalid, the system shows error message MSG 4. |
