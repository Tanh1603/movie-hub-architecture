...
Actor -> GW: (1) POST /v1/halls/hall [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `hall.create` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Create Hall" function and receives the request/event.<br>❖ The system uses trigger [POST /v1/halls/hall]. |
| (3) | BR2 | Validate Rules:<br>❖ The system checks the items [cinemaId], [name], [type], [screenType], [soundSystem], [features], [layoutType].<br>❖ The system validates data according to DTO/schema CreateHallRequest.<br>❖ Required fields: [cinemaId], [name], [type].<br>❖ If any required entries are empty, the system shows error message MSG 1.<br>❖ Optional fields: [screenType], [soundSystem], [features], [layoutType].<br>❖ Default values: [features] = [], [layoutType] = LayoutTypeEnum.STANDARD.<br>❖ Field constraint: [cinemaId] is required, type string, minimum 1.<br>❖ Field constraint: [name] is required, type string, minimum 1; maximum 100.<br>❖ Field constraint: [type] is required, type enum, allowed values: HallTypeEnum.<br>❖ Field constraint: [screenType] is optional, type string, maximum 50.<br>❖ Field constraint: [soundSystem] is optional, type string, maximum 50.<br>❖ Field constraint: [features] is optional, type array<string>, default [].<br>❖ Field constraint: [layoutType] is optional, type value, default LayoutTypeEnum.STANDARD, allowed values: LayoutTypeEnum.<br>❖ If any type, format, enum, range, date, UUID, or email constraint is invalid, the system shows error message MSG 4. |
...
| (8) | BR5 | Error Handling Rules:<br>❖ Gateway forwards the request to the target service through microservice pattern hall.create and propagates service errors through the common exception layer.<br>❖ If a constraint, conflict, or unexpected failure occurs, the system shows error message MSG 9. |
