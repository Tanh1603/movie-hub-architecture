...
Actor -> GW: (1) GET /v1/promotions/code/:code [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `promotion.findByCode` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Find Promotion by Code" function and receives the request/event.<br>❖ The system uses trigger [GET /v1/promotions/code/:code]. |
| (3) | BR2 | Validate Rules:<br>❖ The system checks the items [code].<br>❖ Required fields: [code].<br>❖ If any required entries are empty, the system shows error message MSG 1.<br>❖ Field constraint: [code] is required, type string, path parameter.<br>❖ If any type, format, enum, range, date, UUID, or email constraint is invalid, the system shows error message MSG 4. |
