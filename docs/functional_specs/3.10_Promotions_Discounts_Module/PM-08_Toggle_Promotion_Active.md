...
Actor -> GW: (1) PATCH /v1/promotions/:id/toggle-active [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `promotion.toggleActive` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Toggle Promotion Active" function and receives the request/event.<br>❖ The system uses trigger [PATCH /v1/promotions/:id/toggle-active]. |
