...
Actor -> GW: (1) GET /v1/bookings/:id/refund-calculation [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `booking.calculateRefund` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Calculate Refund" function and receives the request/event.<br>❖ The system uses trigger [GET /v1/bookings/:id/refund-calculation]. |
