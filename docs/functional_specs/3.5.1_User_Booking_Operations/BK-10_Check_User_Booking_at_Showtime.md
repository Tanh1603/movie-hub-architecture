...
Actor -> GW: (1) GET /v1/bookings/showtime/:showtimeId/check [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `booking.findUserBookingByShowtime` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Check User Booking at Showtime" function and receives the request/event.<br>❖ The system uses trigger [GET /v1/bookings/showtime/:showtimeId/check]. |
| (3) | BR2 | Validate Rules:<br>❖ The system checks the items [includeStatuses], [showtimeId].<br>❖ Required fields: [showtimeId].<br>❖ If any required entries are empty, the system shows error message MSG 1.<br>❖ Optional fields: [includeStatuses].<br>❖ Field constraint: [includeStatuses] is optional, type string, query parameter.<br>❖ Field constraint: [showtimeId] is required, type string, path parameter.<br>❖ If any type, format, enum, range, date, UUID, or email constraint is invalid, the system shows error message MSG 4. |
