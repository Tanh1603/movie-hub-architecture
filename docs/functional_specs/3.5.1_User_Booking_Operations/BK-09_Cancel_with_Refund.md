...
Actor -> GW: (1) POST /v1/bookings/:id/cancel-with-refund [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `booking.cancelWithRefund` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Cancel with Refund" function and receives the request/event.<br>❖ The system uses trigger [POST /v1/bookings/:id/cancel-with-refund]. |
| (3) | BR2 | Validate Rules:<br>❖ The system checks the items [id], [reason], [requestRefund].<br>❖ The system validates data according to DTO/schema CancelBookingWithRefundDto.<br>❖ Required fields: [id], [requestRefund].<br>❖ If any required entries are empty, the system shows error message MSG 1.<br>❖ Optional fields: [reason].<br>❖ Field constraint: [id] is required, type string, path parameter.<br>❖ Field constraint: [reason] is optional, type string.<br>❖ Field constraint: [requestRefund] is required, type boolean.<br>❖ If any type, format, enum, range, date, UUID, or email constraint is invalid, the system shows error message MSG 4. |
| (5) | BR3 | Processing Rules:<br>❖ The system executes the main business operation and returns the requested data or persists the state change consistently. |
