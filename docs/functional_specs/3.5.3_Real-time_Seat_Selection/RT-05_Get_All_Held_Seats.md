...
Actor -> GW: (1) Internal Redis query hold:showtime:{showtimeId}:* [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `Internal Redis query hold:showtime:{showtimeId}:*` [BR3]
