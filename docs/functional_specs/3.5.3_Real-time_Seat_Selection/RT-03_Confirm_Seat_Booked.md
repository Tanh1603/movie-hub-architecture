...
Actor -> GW: (1) Redis event booking.confirmed / booking.seat_booked [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `Redis event booking.confirmed / booking.seat_booked` [BR3]
