...
Actor -> GW: (1) GET /v1/ticket-pricing/hall/:hallId [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `ticket_pricing.get_pricing_for_hall` [BR3]
