...
Actor -> GW: (1) PUT /v1/bookings/admin/:id/status [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `booking.updateStatus` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Update Booking Status" function and receives the request/event.<br>❖ The system uses trigger [PUT /v1/bookings/admin/:id/status]. |
| (3) | BR2 | Validate Rules:<br>❖ The system checks the items [status], [reason], [id].<br>❖ Required fields: [status], [id].<br>❖ If any required entries are empty, the system shows error message MSG 1.<br>❖ Optional fields: [reason].<br>❖ Field constraint: [status] is required, type BookingStatus, request body field.<br>❖ Field constraint: [reason] is optional, type string, request body field.<br>❖ Field constraint: [id] is required, type string, path parameter.<br>❖ If any type, format, enum, range, date, UUID, or email constraint is invalid, the system shows error message MSG 4. |
