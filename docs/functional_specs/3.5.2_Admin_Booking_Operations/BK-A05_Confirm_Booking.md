...
Actor -> GW: (1) POST /v1/bookings/admin/:id/confirm [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `booking.confirm` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Confirm Booking" function and receives the request/event.<br>❖ The system uses trigger [POST /v1/bookings/admin/:id/confirm]. |
