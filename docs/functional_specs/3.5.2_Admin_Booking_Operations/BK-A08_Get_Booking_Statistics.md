...
Actor -> GW: (1) GET /v1/bookings/admin/statistics [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `booking.getStatistics` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Get Booking Statistics" function and receives the request/event.<br>❖ The system uses trigger [GET /v1/bookings/admin/statistics]. |
| (3) | BR2 | Validate Rules:<br>❖ The system checks the items [startDate], [endDate], [cinemaId], [showtimeId], [groupBy].<br>❖ The system validates data according to DTO/schema GetBookingStatisticsDto.<br>❖ Optional fields: [startDate], [endDate], [cinemaId], [showtimeId], [groupBy].<br>❖ Field constraint: [startDate] is optional, type Date.<br>❖ Field constraint: [endDate] is optional, type Date.<br>❖ Field constraint: [cinemaId] is optional, type string.<br>❖ Field constraint: [showtimeId] is optional, type string.<br>❖ Field constraint: [groupBy] is optional, type 'day' | 'week' | 'month' | 'cinema' | 'movie', allowed values: day, week, month, cinema, movie.<br>❖ If any type, format, enum, range, date, UUID, or email constraint is invalid, the system shows error message MSG 4. |
