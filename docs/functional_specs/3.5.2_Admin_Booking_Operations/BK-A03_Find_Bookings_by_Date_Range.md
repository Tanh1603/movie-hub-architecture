...
Actor -> GW: (1) GET /v1/bookings/admin/date-range [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `booking.findByDateRange` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Find Bookings by Date Range" function and receives the request/event.<br>❖ The system uses trigger [GET /v1/bookings/admin/date-range]. |
| (3) | BR2 | Validate Rules:<br>❖ The system checks the items [page], [limit], [startDate], [endDate], [status], [cinemaId].<br>❖ The system validates data according to DTO/schema FindBookingsByDateRangeDto.<br>❖ Required fields: [startDate], [endDate].<br>❖ If any required entries are empty, the system shows error message MSG 1.<br>❖ Optional fields: [page], [limit], [status], [cinemaId].<br>❖ Field constraint: [page] is optional, type number.<br>❖ Field constraint: [limit] is optional, type number.<br>❖ Field constraint: [startDate] is required, type Date.<br>❖ Field constraint: [endDate] is required, type Date.<br>❖ Field constraint: [status] is optional, type BookingStatus.<br>❖ Field constraint: [cinemaId] is optional, type string.<br>❖ If any type, format, enum, range, date, UUID, or email constraint is invalid, the system shows error message MSG 4. |
