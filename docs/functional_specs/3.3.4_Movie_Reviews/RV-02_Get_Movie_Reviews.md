...
Actor -> GW: (1) GET /v1/movies/:id/reviews [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `movie.review.list` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Get Movie Reviews" function and receives the request/event.<br>❖ The system uses trigger [GET /v1/movies/:id/reviews]. |
| (3) | BR2 | Validate Rules:<br>❖ The system checks the items [id], [page], [limit], [sortBy], [sortOrder], [rating], [userId], [movieId].<br>❖ The system validates data according to DTO/schema ReviewQuery.<br>❖ Required fields: [id].<br>❖ If any required entries are empty, the system shows error message MSG 1.<br>❖ Optional fields: [page], [limit], [sortBy], [sortOrder], [rating], [userId], [movieId].<br>❖ Field constraint: [id] is required, type ReviewQuery, path parameter.<br>❖ Field constraint: [page] is optional, type number.<br>❖ Field constraint: [limit] is optional, type number.<br>❖ Field constraint: [sortBy] is optional, type string.<br>❖ Field constraint: [sortOrder] is optional, type SortOrder.<br>❖ Field constraint: [rating] is optional, type string.<br>❖ Field constraint: [userId] is optional, type string.<br>❖ Field constraint: [movieId] is optional, type string.<br>❖ If any type, format, enum, range, date, UUID, or email constraint is invalid, the system shows error message MSG 4. |
