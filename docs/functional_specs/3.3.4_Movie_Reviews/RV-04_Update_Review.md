...
Actor -> GW: (1) PUT /v1/movies/:id/reviews/:reviewId [BR1]
GW -> GW: (3) Validate authentication, params, query, and body [BR2]
GW -> SVC: (5) Send `movie.review.updated` [BR3]
...
| :--- | :--- | :--- |
| (1) | BR1 | Loading Screen Rules:<br>❖ The system loads the "Update Review" function and receives the request/event.<br>❖ The system uses trigger [PUT /v1/movies/:id/reviews/:reviewId]. |
| (3) | BR2 | Validate Rules:<br>❖ The system checks the items [reviewId], [movieId], [userId], [rating], [content].<br>❖ The system validates data according to DTO/schema UpdateReviewRequest.<br>❖ Required fields: [reviewId].<br>❖ If any required entries are empty, the system shows error message MSG 1.<br>❖ Optional fields: [movieId], [userId], [rating], [content].<br>❖ Field constraint: [reviewId] is required, type string, path parameter.<br>❖ Field constraint: [movieId] is optional, type value, must be a UUID.<br>❖ Field constraint: [userId] is optional, type string.<br>❖ Field constraint: [rating] is optional, type value, minimum 1; maximum 5; must be an integer.<br>❖ Field constraint: [content] is optional, type string.<br>❖ If any type, format, enum, range, date, UUID, or email constraint is invalid, the system shows error message MSG 4. |
